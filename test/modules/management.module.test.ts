...
import { ManagementClientOptions, ManagementOptionsFactory } from '../../src/auth0.options';
import { AUTH0_MANAGEMENT_CLIENT } from "../../src/constants";
...
describe("Authentication Module", () => {
    ...
    describe("forRoot", () => {
        it("provide management client", async () => {
            ...
            const managementClient = module.get<ManagementClient>(AUTH0_MANAGEMENT_CLIENT);
